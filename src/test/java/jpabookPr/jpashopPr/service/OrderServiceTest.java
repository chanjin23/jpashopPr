...
import jpabookPr.jpashopPr.domain.Address;
import jpabookPr.jpashopPr.domain.Member;
import jpabookPr.jpashopPr.domain.Order;
import jpabookPr.jpashopPr.domain.OrderStatus;
import jpabookPr.jpashopPr.domain.item.Book;
...
public class OrderServiceTest {
    ...
    @Test(expected = NotEnoughStockException.class) //다음 예외가 발생해야 정상적으로 작동
    ...
    public void 주문취소() throws Exception{
        ...
        assertEquals("주문 취소시 상태는 CACNEL이다.", OrderStatus.CANCEL, getOrder.getStatus());
